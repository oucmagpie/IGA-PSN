...
class TrainOpts(BaseOpts):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_dir',    default='Train_Dataset1_your_path')
        self.parser.add_argument('--data_dir2',   default='Train_Dataset2_your_path')
        ...
        #### Training Arguments ####
        self.parser.add_argument('--model',       default='IGA_PSN')
